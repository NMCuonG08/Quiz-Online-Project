...
class AIAgentCore:
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.graph_runner = (
            LangGraphQuizRunner(
                ...
                executor_provider=self.config.get("executor_provider", "openai"),
                executor_fallback_model=self.config.get("executor_fallback_model"),
                executor_fallback_provider=self.config.get("executor_fallback_provider", "openai"),
                executor_fallback_api_key=self.config.get("executor_fallback_api_key"),
                executor_fallback_base_url=self.config.get("executor_fallback_base_url"),
                ...
                executor_attempt_timeout_seconds=float(self.config.get("executor_attempt_timeout_seconds", 60)),
                executor_fallback_timeout_seconds=float(self.config.get("executor_fallback_timeout_seconds", 60)),
                model_failure_threshold=int(self.config.get("model_failure_threshold", 2)),
                model_cooldown_seconds=float(self.config.get("model_cooldown_seconds", 30)),
    ...
    def _normalize_write_args(name: str, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        quiz_type_aliases = {
            ...
            "MULTIPLE_ANSWER": "MULTIPLE_CHOICE", "MULTIPLE_ANSWERS": "MULTIPLE_CHOICE",
