...
function getPermissionDescription(permission: string): string {
  const descriptions: Record<string, string> = {
    ...
    // Album permissions
    [Permission.QuizCreate]: 'Create albums',
    [Permission.QuizRead]: 'Read albums',
    [Permission.QuizUpdate]: 'Update albums',
    [Permission.QuizDelete]: 'Delete albums',
    [Permission.QuizStatistics]: 'View album statistics',
    [Permission.QuizShare]: 'Share albums',
