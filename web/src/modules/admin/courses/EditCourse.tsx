...
export default function EditCourse() {
    ...
    useEffect(() => {
        ...
        const fetchDetail = async () => {
            setIsLoading(true);
            const { success, data } = await AdminCourseService.getCourseById(courseId);
            if (success && data) {
                reset({
                    title: data.title,
                    ...
                    price: data.price,
                    thumbnailPreview: data.thumbnail_url || null,
                    thumbnailFile: null,
    ...
    const onSubmit = async (data: CourseFormData) => {
        ...
        const success = await updateCourse(courseId, submitData);
