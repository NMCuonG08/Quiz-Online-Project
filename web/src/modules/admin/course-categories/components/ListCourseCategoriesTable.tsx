            ...
            <div className="rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-[#122031] dark:shadow-card sm:p-7.5">
                <div className="mb-4 flex items-center justify-end">
                    <Button
                        ...
                        onClick={() => router.push("/admin/course-categories/add")}
                    >
                        Add
                    </Button>
                </div>
                                    ...
                                    <TableCell className="min-w-[120px] xl:pl-7.5">
                                        <div className="flex items-center gap-x-3.5">
                                            <button
                                                ...
                                                aria-label="View course category"
                                            >
                                                <span className="sr-only">View Course Category</span>
                                                <PreviewIcon />
                                            </button>
                                            ...
                                            <button
                                                ...
                                                aria-label="Edit course category"
                                                onClick={() =>
                                                    router.push(
                                                        `/admin/course-categories/edit/${item.slug}`
                                                    )
                                                }
                                            >
                                                <span className="sr-only">Edit Course Category</span>
                                                <PencilSquareIcon />
                                            </button>
                                            ...
                                            <button
                                                ...
                                                aria-label="Delete course category"
                                                onClick={async () => {
                                            ...
                                            >
                                                <span className="sr-only">Delete Course Category</span>
                                                <TrashIcon />
                                            </button>
                                        </div>
                                    </TableCell>
...
export default ListCourseCategoriesTable;
