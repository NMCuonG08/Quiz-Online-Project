...
const SingleChoiceRenderer: React.FC<QuestionRendererProps> = (props) => {
    const {
        question,
        selectedAnswer,
        onAnswerSelect,
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center p-3 sm:p-5 md:p-6">
            ...
            {/* Answer Options - single selection */}
...
export class SingleChoiceStrategy implements IQuestionRendererStrategy {
