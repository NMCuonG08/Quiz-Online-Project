...
const HowItWorksSection = () => {
  const steps = [
    ...
    },
    {
      ...
      stepNumber: "",
      title: "Join the quiz",
      description: "Connect with friends or join global challenges",
      linkText: "Discover >",
      icon: (
        <svg
          width="24"
    ...
    },
    {
      ...
      description: "Earn points, track progress, and improve your skills",
      linkText: "Play now >",
      icon: (
        <svg
          width="24"
  ...
  return (
    <section className="w-full py-16 px-4 sm:px-8 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Three easy steps to start your learning journey
          </p>
        </div>
