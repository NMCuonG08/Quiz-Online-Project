...
import { loginUser } from "@/modules/auth/common/slices/authSlice";
...
const LoginForm = () => {
  ...
  // Clear error khi user bắt đầu typing
  const handleFormChange = () => {
    // Clear error logic removed since we handle errors directly in onSubmit
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="space-y-4">
          ...
          <Button
            ...
            className="w-full h-11 border border-border bg-[rgb(59,130,246)] hover:bg-accent hover:text-accent-foreground rounded-lg font-medium transition-colors text-white"
          >
            <svg
              className="w-4 h-4 mr-2 transition-colors duration-200 fill-white group-hover:fill-black"
              viewBox="0 0 24 24"
