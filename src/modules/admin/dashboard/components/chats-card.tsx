import { DotIcon } from "@/modules/admin/common/components/icons";
...
export async function ChatsCard() {
  ...
  return (
    <div className="col-span-12 rounded-[10px] bg-white py-6 shadow-1 dark:bg-[#122031] dark:shadow-card xl:col-span-4">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  <span
                    className={cn(
                      ...
                      chat.unreadCount && "text-dark-4 dark:text-white"
                    )}
                  >
